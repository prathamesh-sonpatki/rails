...
module ActionController
  ...
  class Parameters
    ...
    def to_h
      if permitted?
        convert_parameters_to_hashes(@parameters, allow_unsafe: false)
      else
    ...
    # parameter.
    def to_unsafe_h
      convert_parameters_to_hashes(@parameters, allow_unsafe: true)
    end
    ...
    private
      ...
      def convert_parameters_to_hashes(value, allow_unsafe:)
        case value
        when Array
          value.map { |v| convert_parameters_to_hashes(v, allow_unsafe: allow_unsafe) }
        when Hash
          value.transform_values do |v|
            convert_parameters_to_hashes(v, allow_unsafe: allow_unsafe)
